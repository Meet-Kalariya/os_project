  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(pages.title ,style: GoogleFonts.montserrat(textStyle: TextStyle(color: Colors.white,
              fontSize: 14,
        ...
        body: Container(
          child: Column(
            ...
            children: <Widget>[
              ...
              // // ),
            Center(
              child: Text('Theory', style: GoogleFonts.roboto(textStyle: TextStyle(color: Colors.black,
                fontSize: 18,
              ...
              Padding(
                ...
                child: SizedBox(
                    height: 250,
                    child: Text(pages.info, style: GoogleFonts.roboto(textStyle: TextStyle(color: Colors.black,
                        fontSize: 16,
                        fontWeight: FontWeight.w400,
                        fontStyle: FontStyle.normal)),
                    ),
