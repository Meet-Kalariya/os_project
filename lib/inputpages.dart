          ...
          child: Column(
            ...
            children: <Widget>[
                ...
                children: <Widget>[
                  Container(
                      ...
                      child: TextField(
                        ...
                        autocorrect: true,
                        decoration:
                            InputDecoration(hintText: 'Enter the frame size'),
                      )),
                  RaisedButton(
              ...
              Padding(
                  ...
                  child: Text("Frame capacity = $frame_capacity",
                      style: GoogleFonts.roboto(
                          textStyle: TextStyle(
                              color: Colors.black,
                              fontSize: 14,
              ...
              Padding(
                  ...
                  child: Text("Entered pages are = $pages_arr",
                      style: GoogleFonts.roboto(
                          textStyle: TextStyle(
                              color: Colors.black,
                              fontSize: 14,
              ...
              Row(
                ...
                children: <Widget>[
                  RaisedButton(
                    ...
                    // child:Text('Clear All' ,style: GoogleFonts.roboto(textStyle: TextStyle(color: Colors.white,
                    //     fontSize: 14,
                    //     fontWeight: FontWeight.w500,
                    //     fontStyle: FontStyle.normal ))
                    // ),
                    ...
                    onPressed: () {
                      if (pages_arr.length != 0) {
                        if (signal == 1) {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => FIFO()),
                          );
                        }
                        if (signal == 2) {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => LIFO()),
                          );
                        }
                        if (signal == 3) {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => LRU()),
                          );
                        }
                        if (signal == 4) {
                          optimalalgo(
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => OPTIMAL()),
                          );
                        }
                        if (signal == 5) {
